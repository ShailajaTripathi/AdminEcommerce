...
import { colormanagement, materialmanagement } from '../../config/routingConsts';
...
const MaterialAddEdit = () => {
  ...
  const {
    ...
    // view-color on id //
    async function viewColors(materialId) {
